...
public partial class Main : DoubleBufferedControl
{
    ...
    private void LoadSettings()
    {
        ...
        checkUseSpeedOnWalkback.Checked = PlayerConfig.Get(key + "checkUseSpeedOnWalkback", true);
    ...
    private void txtWalkscript_Click(object sender, EventArgs e)
    {

    }


    private void checkUseSpeedOnWalkback_CheckedChanged(object sender, EventArgs e)

    {
        if (_settingsLoaded)
        {
            PlayerConfig.Set("RSBot.Training.checkUseSpeedOnWalkback", checkUseSpeedOnWalkback.Checked);
        }
    }
}
